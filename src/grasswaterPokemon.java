public class grasswaterPokemon extends pokemon implements waterable {
    ...
    public grasswaterPokemon(String name, int HP, int level, int solarAbsorbtion, int grassHazard, int grassShield, int dustScreen) {
        super(name, HP, level);
    ...
    public void waterBlast() {
        System.out.println("Pokemon does creates a leaf of screen and blasts water!");
    }

    public void hydroPump() {
        System.out.println("Pokemon gathers water surrounding him and uses Hydropump!");
    }
}
